...
// NewHangoverDataOpener creates a new button that selects the nquads and pathbuilder from the given folder.
func NewHangoverDataOpener(label string, parent fyne.Window, vNq, vPB binding.String) *widget.Button {
